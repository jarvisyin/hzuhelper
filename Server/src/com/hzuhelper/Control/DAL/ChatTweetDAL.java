...
public class ChatTweetDAL {
	...
	public ArrayList<ChatTweet> getList(String author_id)
			throws SQLException {
		ArrayList<ChatTweet> clist = null;
		try {
			...
			rs = pst.executeQuery();
			clist = new ArrayList<ChatTweet>();
			while (rs.next()) {
				ChatTweet model = new ChatTweet();
	...
	public ArrayList<ChatTweet> getList(int _id, String _authorId)
			throws SQLException {
		ArrayList<ChatTweet> clist = null;
		try {
			connection = msh.getConnection();
	...
	public ArrayList<ChatTweet> getList(int _id) throws SQLException {
		ArrayList<ChatTweet> clist = null;
		try {
			connection = msh.getConnection();
			String sqlText = "select * from " + TABLE_NAME + " where " + id
	...
	public ArrayList<ChatTweet> getList() throws SQLException {
		ArrayList<ChatTweet> clist = null;
		try {
			connection = msh.getConnection();
	...
	public ArrayList<ChatTweet> getList(int _id, int _tagId)
			throws SQLException {
		ArrayList<ChatTweet> clist = null;
		try {
			connection = msh.getConnection();
	...
	public ChatTweet getModel(int _id) throws SQLException {
		try {
			connection = msh.getConnection();
	...
	public void add(ChatTweet _chatTweetInfo) throws SQLException {
		try {
			connection = msh.getConnection();
	...
	private ChatTweet rsToModel(ResultSet rs, ChatTweet model)
			throws SQLException {
