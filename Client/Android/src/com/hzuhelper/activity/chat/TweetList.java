...
public class TweetList extends BaseActivity {
    ...
    private ArrayList<ARRAY_CT0001> tweetAllList1;
    private ArrayList<ARRAY_CT0001> tweetAllList2;
    ...
    private void initTweetAllListView(){
        tweetAllList1 = new ArrayList<ARRAY_CT0001>();
        tweetAllList2 = null;
    ...
    private void TweetAllGetMoreDate(){
        new Thread(new Runnable() {
            public void run(){
                ...
                ARRAY_CT0001 model = tweetAllList1.get(listSize-1);
     ...
     * 网络获取数据
     */
    private ArrayList<ARRAY_CT0001> loadTweetAllData(String url){
        ArrayList<ARRAY_CT0001> list = new ArrayList<ARRAY_CT0001>(20);
        ...
        try {
            ...
            for (int i = 0, length = jsonResponse.length(); i<length; i++) {
                ...
                ARRAY_CT0001 m = new ARRAY_CT0001();
    ...
    private ArrayList<ARRAY_CT0001> tweetMineList1;
    private ArrayList<ARRAY_CT0001> tweetMineList2;
    ...
    private void initTweetMineListView(){
        tweetMineList1 = new ArrayList<ARRAY_CT0001>();
        tweetMineList2 = null;
    ...
    private void tweetMineGetMoreDate(){
        new Thread(new Runnable() {
            public void run(){
                ...
                ARRAY_CT0001 model = tweetMineList1.get(listSize-1);
     ...
     * 网络获取数据
     */
    private ArrayList<ARRAY_CT0001> loadTweetMineData(String url){
        ArrayList<ARRAY_CT0001> list = new ArrayList<ARRAY_CT0001>(20);
        WebRequest wq = new WebRequest(url);
